...
import 'package:covid19/settings/main_settings.dart';
...
class DashboardPageState extends State<DashboardPage> {
  ...
  void initState() {
    ...
    _appPreference.getCacheNcdc().then((data){
      setState(() {
        if(data == null)return;
        List<String> cachedList = List.from(json.decode(data));
        cachedList.forEach((result){
          var regex = RegExp("\\d");
                          ...
                          Expanded(
                            ...
                            child: new InkWell(
                              child: IconButton(icon: new Icon(Icons.settings,
                                ...
                                MainSettingsPage.start(context, _appPreference);
                              }),
                            ),
                          )
                        ],
                          ...
                          child: Row(
                            ...
                            children: <Widget>[
                              ...
                              new Column(
                                ...
                                children: <Widget>[
                                  Image.asset(
                                    otherTitles[1].toString().toLowerCase() =='Total '
                                        'Active '
                                        'Cases'.toLowerCase() ?
                                    "assets/images/siren_ic.png": "assets/images/total_discharge_ic.png",
                                  ),
                                  Padding(padding: EdgeInsets.all(5)),
                                  Expanded(
                                    flex: 0,
